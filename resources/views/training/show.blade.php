...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Attribute HTML `hidden` (usado pra ocultar o botao ate o ultimo slide)
           precisa vencer regras que setam `display:` no elemento — usamos display:none
           explicito com maior especificidade. */
        .bfm-continue[hidden] { display: none; }
